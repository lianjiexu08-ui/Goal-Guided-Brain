...
- [x] Existing regression suite plus new deterministic integration tests: 133/133, no skips.
...
The current deterministic suite contains 133 passing tests. The repeatable
